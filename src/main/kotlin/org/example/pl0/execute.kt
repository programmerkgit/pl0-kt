...
abstract class Instruction2(opCode: Code, val value: Int) : Instruction(opCode)
class Lit(value: Int) : Instruction2(Code.lit, value)
class Ict(value: Int) : Instruction2(Code.ict, value)
class Jmp(value: Int) : Instruction2(Code.jmp, value)
...
class Dev : Instruction3(Code.opr)
...
fun execute(instructions: MutableList<Instruction>) {
    ...
    do {
        ...
        when (val inst = instructions[pc++]) {
            ...
            is Dev -> stack.add(stack.pop() * stack.pop())
